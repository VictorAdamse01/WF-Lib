...
int main() {
    ...
    wflib::wireframe Octahedron(wf_display);

    //Add wireframe from raw data by giving lines
    Octahedron.Add_edge_by_vertices(wflib::vertex(  0,-20,  0),wflib::vertex(-10,  0,-10));
    Octahedron.Add_edge_by_vertices(wflib::vertex(  0,-20,  0),wflib::vertex( 10,  0,-10));
    Octahedron.Add_edge_by_vertices(wflib::vertex(  0,-20,  0),wflib::vertex(-10,  0, 10));
    Octahedron.Add_edge_by_vertices(wflib::vertex(  0,-20,  0),wflib::vertex( 10,  0, 10));
    Octahedron.Add_edge_by_vertices(wflib::vertex(  0, 20,  0),wflib::vertex(-10,  0,-10));
    ...
    Octahedron.Add_edge_by_vertices(wflib::vertex(  0, 20,  0),wflib::vertex(-10,  0, 10));
    Octahedron.Add_edge_by_vertices(wflib::vertex(  0, 20,  0),wflib::vertex( 10,  0, 10));
    Octahedron.Add_edge_by_vertices(wflib::vertex(-10,  0,-10),wflib::vertex(-10,  0, 10));
    Octahedron.Add_edge_by_vertices(wflib::vertex(-10,  0, 10),wflib::vertex( 10,  0, 10));
    Octahedron.Add_edge_by_vertices(wflib::vertex( 10,  0, 10),wflib::vertex( 10,  0,-10));
    Octahedron.Add_edge_by_vertices(wflib::vertex( 10,  0,-10),wflib::vertex(-10,  0,-10));

    //rescale the wireframe to better fit the screen
    Octahedron.Scale_towards(35);
    ...
    for(;;){
        ...
        //rotate when button 1 is pressed
        if(button1.get()){
            Octahedron.Rotate(0.1,rotate_axis);
        }

        //change rotation axis when button 2 is pressed
        if(button_timer <= 0 && button2.get()){
